...
#define lPush pushMatrix()
#define lPop  popMatrix()

#define Push DrawUtils::lPush
#define Pop  DrawUtils::lPop

class DrawUtils
{
private:
	static std::stack<vec2_t> matrix;
	static			  vec2_t current;
public:
	...
	static void translate(vec2_t pos);
	static void lPush;
	static void lPop;
