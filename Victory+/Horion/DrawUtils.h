...
public:
	...
	static void drawLine1(const vec2_t& start, const vec2_t& end, float lineWidth);  // rgba
	...
	static void drawBox2X(const vec3_t& lower, const vec3_t& upper, float lineWidth, bool outline = false, bool fill = false);
	static void drawBox(const vec3_t& lower, const vec3_t& upper, float lineWidth, bool outline = false, bool fill = false);
	static void drawBoxv2(const vec3_t& lower, const vec3_t& upper, float lineWidth, bool outline = false, bool fill = true);
	//static void drawBoxv3(const vec3_t& lower, const vec3_t& upper, float lineWidth, bool outline = false, bool fill = true);
