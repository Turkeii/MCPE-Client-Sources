...
void ModuleManager::initModules() {
	logF("Initializing modules");
	{
		...
		this->moduleList.push_back(std::shared_ptr<IModule>(new DropperEsp()));
		...
		this->moduleList.push_back(std::shared_ptr<IModule>(new ZeroTP()));
		...
		//this->moduleList.push_back(std::shared_ptr<IModule>(new AutoTimer()));
	    ...
	    //this->moduleList.push_back(std::shared_ptr<IModule>(new PistonAura()));
		//this->moduleList.push_back(std::shared_ptr<IModule>(new CAtwo()));
		...
		//this->moduleList.push_back(std::shared_ptr<IModule>(new PacketMine()));
		//this->moduleList.push_back(std::shared_ptr<IModule>(new ArrayList()));
		this->moduleList.push_back(std::shared_ptr<IModule>(new BoatFly()));
		...
		this->moduleList.push_back(std::shared_ptr<IModule>(new JavaAura()));
		this->moduleList.push_back(std::shared_ptr<IModule>(new CrystalMove()));
	    //this->moduleList.push_back(std::shared_ptr<IModule>(new CrystalReplenishment()));
		this->moduleList.push_back(std::shared_ptr<IModule>(new AnchorAura()));
		...
		this->moduleList.push_back(std::shared_ptr<IModule>(new StrafeSpeed()));
		...
		this->moduleList.push_back(std::shared_ptr<IModule>(new HoleEsp()));
		this->moduleList.push_back(std::shared_ptr<IModule>(new ReverseKnockBack()));
		this->moduleList.push_back(std::shared_ptr<IModule>(new CrystalAura2()));
		//this->moduleList.push_back(std::shared_ptr<IModule>(new CrystalPlace()));
		...
		this->moduleList.push_back(std::shared_ptr<IModule>(new BowSpam()));
		this->moduleList.push_back(std::shared_ptr<IModule>(new ShieldBreak));
		this->moduleList.push_back(std::shared_ptr<IModule>(new HoleFiller()));
		...
		this->moduleList.push_back(std::shared_ptr<IModule>(new AirWalk()));
		this->moduleList.push_back(std::shared_ptr<IModule>(new XPFast()));
