...
static constexpr float backgroundAlpha = 0.3;

static const MC_Color whiteColor = MC_Color(0.f, 1.f, 0.f, 1.f);
static const MC_Color moduleColor = MC_Color(0.0f, 0.0f, 0.1f, 0.5f); // background
static const MC_Color selectedModuleColor = MC_Color(1.f, 1.f, 1.f);    // 30, 110, 200
static const MC_Color enabledModuleColor = MC_Color(0.f, 1.f, 1.f);
static const MC_Color brightModuleBlendColor = MC_Color(0.f, 0.f, 1.f, 0.0f); // tooltip border & category divider
...
static const MC_Color SettingColor1 = MC_Color(0.8f, 0.8f, 0.8f);
static const MC_Color SettingColor2 = MC_Color(0.8f, 0.8f, 0.8f, 0.5f);
...
void ClickGui::renderTooltip(std::string* text) {
	...
	DrawUtils::fillRectangle(rectPos, MC_Color(0.65f, 0.f, 0.f), 0.4f);
...
void ClickGui::renderCategory(Category category) {
	...
	// Draw Category Header
	{
		...
		// Draw category component
		{
			...
			DrawUtils::fillRectangle(rectPos, MC_Color(0.f, 0.f, 1.f), 0.4f);
