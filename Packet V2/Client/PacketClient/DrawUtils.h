...
public:
	...
	static int getRainbow(float seconds, float saturation, float brightness, long index);
	...
	static void drawRoundRectangle(vec4_t pos, const MC_Color col, float alpha);
