...
public:
	...
	bool isCrystal(void) {
		if (((std::string)name.getText()).find("end_crystal") != std::string::npos) return true;
		return false;
	}
	bool isObsidian(void) {
		if (((std::string)name.getText()).find("obsidian") != std::string::npos) return true;
		return false;
	}
	bool isBlock(void) {
