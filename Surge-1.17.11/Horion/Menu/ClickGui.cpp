...
static const MC_Color SettingColor1 = MC_Color(10, 25, 45); //not enabled enums
static const MC_Color SettingColor2 = MC_Color(20, 35, 55);	//enabled enums and enums when hovering over with mouse
