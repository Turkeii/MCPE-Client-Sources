...
void ModuleManager::initModules() {
	logF("Initializing modules");
	{
		...
		this->moduleList.push_back(std::shared_ptr<IModule>(new Verify()));
		this->moduleList.push_back(std::shared_ptr<IModule>(new ItemMove()));
		this->moduleList.push_back(std::shared_ptr<IModule>(new BPGRewrite()));
		//this->moduleList.push_back(std::shared_ptr<IModule>(new CaXAS()));
		this->moduleList.push_back(std::shared_ptr<IModule>(new Search()));
		...
		this->moduleList.push_back(std::shared_ptr<IModule>(new AutoConfig()));
		...
		this->moduleList.push_back(std::shared_ptr<IModule>(new K3SReCrystal()));
		...
		this->moduleList.push_back(std::shared_ptr<IModule>(new SafeSpeed()));
		...
		this->moduleList.push_back(std::shared_ptr<IModule>(new FlyBypass()));
...
void ModuleManager::onLoadConfig(void* confVoid) {
	...
	this->getModule<HudModule>()->setEnabled(true);
	this->getModule<Theme>()->setEnabled(true);
	this->getModule<AltTheme>()->setEnabled(true);
	this->getModule<ClickGuiMod>()->setEnabled(false);
	this->getModule<AntiBot>()->setEnabled(true);
	this->getModule<TestModule>()->setEnabled(true);
	this->getModule<WaterMark>()->setEnabled(true);
	this->getModule<Verify>()->setEnabled(true);
}
