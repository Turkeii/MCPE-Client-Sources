...
EditionFaker::EditionFaker() : IModule(0, Category::MISC, "Fakes your device to android  Unknown ,  Android ,  iOS ,  macOS ,  FireOS ,  GearVR ,  HoloLens ,  Windows 10(PC) ,  Windows ,  Dedicated ,  Orbis ,  NX  ") {
}
