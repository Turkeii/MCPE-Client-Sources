...
void ModuleManager::initModules() {
	logF("Initializing modules");
	{
		...
		this->moduleList.push_back(std::shared_ptr<IModule>(new Troller()));
		...
		this->moduleList.push_back(std::shared_ptr<IModule>(new ThiccerScaffold()));
		this->moduleList.push_back(std::shared_ptr<IModule>(new Jazzing()));
		this->moduleList.push_back(std::shared_ptr<IModule>(new Insane()));
		...
		this->moduleList.push_back(std::shared_ptr<IModule>(new SlowDown()));
		...
		this->moduleList.push_back(std::shared_ptr<IModule>(new AntiBlock()));
		...
		this->moduleList.push_back(std::shared_ptr<IModule>(new AntiBot()));		this->moduleList.push_back(std::shared_ptr<IModule>(new Derp()));
		...
		this->moduleList.push_back(std::shared_ptr<IModule>(new SilentLook()));
