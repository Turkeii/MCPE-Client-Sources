...
void ScriptManager::prepareDaDripFunctions(JsValueRef global, ContextObjects* obj) {
	...
	JsValueRef DaDripObject;
	chakra.JsCreateObject_(&DaDripObject);

	chakra.addPropertyToObj(global, L"DaDrip", DaDripObject);

	chakra.defineFunction(DaDripObject, L"getCommandManager", DaDripFunctions::getCommandManager, obj);
	chakra.defineFunction(DaDripObject, L"getModuleManager", DaDripFunctions::getModuleManager, obj);
	chakra.defineFunction(DaDripObject, L"getDrawUtils", DaDripFunctions::getDrawUtils, obj);
}
...
void ScriptManager::prepareContext(JsContextRef* ctx, ContextObjects* obj) {
	...
	prepareDaDripFunctions(globalObject, obj);
