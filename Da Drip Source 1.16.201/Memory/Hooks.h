...
#include "../DaDrip/Command/CommandMgr.h"
#include "../DaDrip/Config/ConfigManager.h"
#include "../DaDrip/DrawUtils.h"
#include "../DaDrip/ImmediateGui.h"
#include "../DaDrip/Menu/ClickGui.h"
#include "../DaDrip/Menu/TabGui.h"
#include "../DaDrip/Module/ModuleManager.h"
...
private:
	...
	static float GetGamma(C_Option** optionList);
	...
	static void UpdatePointerStruct(void* a1);
	static bool BeaconBlockActor_isPaymentItem(void* a1);

	std::unique_ptr<FuncHook> BeaconBlockActor_isPaymentItemHook;
	...
	std::unique_ptr<FuncHook> UpdatePointerStructHook;
};
