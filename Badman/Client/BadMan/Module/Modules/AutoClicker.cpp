...
AutoClicker::AutoClicker() : IModule(0, Category::COMBAT, "A simple autoclicker, automatically clicks for you.") {
	...
	this->registerBoolSetting("mineplex", &this->mineplex, this->mineplex);
...
void AutoClicker::onTick(C_GameMode* gm) {
	...
	if ((GameData::isLeftClickDown() || !hold) && GameData::canUseMoveKeys()) {
		...
		if (Odelay >= actualDelay) {
			...
			if (mineplex && !(selectedItemId == 268 || selectedItemId == 272 || selectedItemId == 267 || selectedItemId == 283 || selectedItemId == 276 /*swords*/
							  || selectedItemId == 271 || selectedItemId == 275 || selectedItemId == 258 || selectedItemId == 286 || selectedItemId == 279 /*axes*/))
				return;

			else if (weapons && !(selectedItemId == 308 || selectedItemId == 312 || selectedItemId == 322 || selectedItemId == 307 || selectedItemId == 316 || selectedItemId == 592    /*swords*/
