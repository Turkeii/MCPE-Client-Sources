	...
	if (this->enabled != enabled) {
		...
		if (AnnouncerMod->isEnabled()) {
			if (AnnouncerMod->Module) {
				...
				textPacket.message.setText(AnnouncerMod->BadMan ? (enabled ? ("I Just Enabled " + john + " #BadManOnTop") : ("I Just Disabled " + john + " #BadManOnTop")) : AnnouncerMod->bypass ? (enabled ? ("I Just Enabled " + john + " | " + Utils::randomString(8)) : ("I Just Disabled " + john + " | " + Utils::randomString(8))) : enabled ? ("I Just Enabled " + john) : ("I Just Disabled " + john));
