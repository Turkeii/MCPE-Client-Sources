...
Coordinates::Coordinates() : IModule(0x0, Category::VISUAL, "Tells the player their coords") {
		...
		if (!(g_Data.getLocalPlayer() == nullptr)) {
			...
			if (curDim == 0 || curDim == 2) {
				...
				if (curDim == 0) {
					...
					DrawUtils::drawText(textPos, &coordsText, MC_Color(Theme::rFloat, Theme::gFloat, Theme::bFloat), scale - 0.001f * 1.3f, 1.f, Fonts::SMOOTH);
					yVal += f;
				} else if (curDim == 2) {
				...
				DrawUtils::drawText(NtextPos, &NcoordsText, MC_Color(Theme::rFloat, Theme::gFloat, Theme::bFloat), scale - 0.001f * 1.3f, 1.f, Fonts::SMOOTH);
			}
